...
class ArticleConfigurationItemCategoryAssociationServiceTest extends AbstractTest
{
    ...
    {
        $values = ClientMock::mockValues(Faker::create(), ArticleConfigurationItemCategoryAssociationEntity::class);

        $entity = new ArticleConfigurationItemCategoryAssociationEntity($values);
