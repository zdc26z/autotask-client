 ...
 */
class ResourceTimeOffApproverPaginator
{
    /** @var ResourceTimeOffApproverCollection Collection of resourcetimeoffapprovers. */
    public ResourceTimeOffApproverCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ResourceTimeOffApproverCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ResourceTimeOffApproverPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ResourceTimeOffApproverPaginator
    {
        if(is_null($this->postParams)){
