...
class ConfigurationItemEntity extends Entity
{
    ...
    public function __construct(
        ...
        #[CastCarbon]
                public Carbon $domainExpirationDateTime = new Carbon(), 
        #[CastCarbon]
                public Carbon $domainLastUpdatedDateTime = new Carbon(), 
                public int $domainRegistrarID = '', 
        #[CastCarbon]
                public Carbon $domainRegistrationDateTime = new Carbon(), 
                public float $hourlyCost = '', 
                public int $id, 
                public int $impersonatorCreatorResourceID = '', 
        #[CastCarbon]
                public Carbon $installDate = new Carbon(), 
        ...
        #[CastCarbon]
                public Carbon $lastModifiedTime = new Carbon(), 
        ...
        #[CastCarbon]
                public Carbon $sslValidFromDateTime = new Carbon(), 
        #[CastCarbon]
                public Carbon $sslValidUntilDateTime = new Carbon(), 
                public int $vendorID = '', 
        #[CastCarbon]
                public Carbon $warrantyExpirationDate = new Carbon(), 
